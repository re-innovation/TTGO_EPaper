...
bool DecodeWeather(WiFiClient& json, String Type, Forecast_record_type _WxConditions[], Forecast_record_type _WxForecast[]) 
{
  ...
  if (Type == "weather") {
    ...
    _WxConditions[0].Main0       = root["weather"][0]["main"].as<const char*>();            Serial.print("Main0: "); Serial.println(_WxConditions[0].Main0);
    _WxConditions[0].Forecast0   = root["weather"][0]["description"].as<const char*>();     Serial.print("Fore0: "); Serial.println(_WxConditions[0].Forecast0);
    _WxConditions[0].Forecast1   = root["weather"][1]["main"].as<const char*>();            Serial.print("Fore1: "); Serial.println(_WxConditions[0].Forecast1);
    _WxConditions[0].Forecast2   = root["weather"][2]["main"].as<const char*>();            Serial.print("Fore2: "); Serial.println(_WxConditions[0].Forecast2);
    _WxConditions[0].Icon        = root["weather"][0]["icon"].as<const char*>();            Serial.print("Icon : "); Serial.println(_WxConditions[0].Icon);
    ...
    _WxConditions[0].Country     = root["sys"]["country"].as<const char*>();                Serial.print("Coun : "); Serial.println(_WxConditions[0].Country);
  ...
  if (Type == "forecast") {
    ...
    for (byte r = 0; r < MAX_WEATHER_READINGS; r++) {
      Serial.println("\nPeriod-" + String(r) + "--------------");
      _WxForecast[r].Dt          = list[r]["dt"].as<const char*>();
      ...
      _WxForecast[r].Forecast0   = list[r]["weather"][0]["main"].as<const char*>();         Serial.print("Fore0: "); Serial.println(_WxForecast[r].Forecast0);
      _WxForecast[r].Forecast0   = list[r]["weather"][1]["main"].as<const char*>();         Serial.print("Fore1: "); Serial.println(_WxForecast[r].Forecast1);
      _WxForecast[r].Forecast0   = list[r]["weather"][2]["main"].as<const char*>();         Serial.print("Fore2: "); Serial.println(_WxForecast[r].Forecast2);
      _WxForecast[r].Description = list[r]["weather"][0]["description"].as<const char*>();  Serial.print("Desc : "); Serial.println(_WxForecast[r].Description);
      _WxForecast[r].Icon        = list[r]["weather"][0]["icon"].as<const char*>();         Serial.print("Icon : "); Serial.println(_WxForecast[r].Icon);
      ...
      _WxForecast[r].Period      = list[r]["dt_txt"].as<const char*>();                     Serial.print("Peri : "); Serial.println(_WxForecast[r].Period);
    }
    //------------------------------------------
